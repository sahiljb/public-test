    ...
    <div class="row" id="cancel-row">
        <div class="col-xl-9 col-lg-9 col-sm-9 layout-top-spacing layout-spacing">
            ...
            <div class="widget-content widget-content-area br-8">
                ...
                <form method="post" action="{{ route('customer.save',[$userDetail->id]) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-4">
                        <div class="col-xxl-6 mb-4">
                            <label>Name<span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="uname" name="uname" placeholder="Name" value="{{ old('uname', $userDetail->name) }}" >
                            @error('uname')
                        ...
                        <div class="col-xxl-6 mb-4">
                            ...
                            <input type="text" class="form-control" id="uemail" name="uemail" placeholder="Email" value="{{ old('uemail', $userDetail->email) }}" >
                            @error('uemail')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-xxl-6 mb-4">
                            ...
                            <input type="text" class="form-control" id="uphone" name="uphone" placeholder="Phone" value="{{ old('uphone', $userDetail->phone) }}" >
                            @error('uphone')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-xxl-6 mb-4">
                            ...
                            <div class="col-md-12 mt-4">
                                <img src="{{url('storage/'.$userDetail->profile)}}" class="w-25">
                            </div>
                            @endif
                        ...
                        <div class="col-xxl-6 mb-4">
                            ...
                            <div class="col-12">
                                ...
                                @error('upassword')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                                <small class="text-info">Note: Leave blank if you do not want to change the password.</small>
