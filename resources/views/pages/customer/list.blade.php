<x-base-layout :scrollspy="false">
                ...
                <table id="table-list" class="table dt-table-hover" style="width:100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href=""><span class="inv-number">#098424</span></a></td>
                            <td>
                                <div class="d-flex">
                        ...
                        <tr>
                            ...
                            <td><a href=""><span class="inv-number">#095841</span></a></td>
                            <td>
                                <div class="d-flex">
                                    <div class="usr-img-frame me-2 rounded-circle">
                            ...
                            <td><span class="badge badge-light-warning inv-status">Deactive</span></td>
                        ...
                        <tr>
                            ...
                            <td><a href=""><span class="inv-number">#102261</span></a></td>
                            <td>
                                <div class="d-flex">
                                    <div class="usr-img-frame me-2 rounded-circle">
                                        <img alt="avatar" class="img-fluid rounded-circle" src="{{Vite::asset('resources/images/profile-21.jpeg')}}">
    ...
    <x-slot:footerFiles>
        ...
        <script>
           var invoiceList = $('#table-list').DataTable({
